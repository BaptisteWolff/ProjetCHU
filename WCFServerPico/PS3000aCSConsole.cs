...
namespace PS3000ACSConsole
{
    ...
    class PS3000ACSConsole
    {
       ...
       ****************************************************************************/
        ...
        ****************************************************************************/
        void CollectBlockRapid()
        {
            ...
            Console.WriteLine("Collecting {0} rapid blocks", numRapidCaptures);
       ...
       ****************************************************************************/
        ...
        ****************************************************************************/
         ...
         ****************************************************************************/
        void SetVoltages(uint[] range)
        {         
            for (int ch = 0; ch < _channelCount; ch++)
            {
                if (range[ch] != 99)
                {
                    _channelSettings[ch].range = (Imports.Range)range[ch];
     ...
     ***************************************************************************/
        ...
        ****************************************************************************/
        ...
        public void setPico(uint timebase, int sampleCount, string filename, uint[] range)
        {
            // setup devices
            GetDeviceInfo();
            _timebase = timebase;
